    ...
    return (
        ...
        <section>
            ...
            <div className="flex flex-col">
                <ul className="flex flex-col text-center md:grid md:grid-cols-2 lg:grid-cols-3 items-center content-center mr-auto ml-auto">
                    {movies?.map(response => {
                        const resumeOverview = response.overview.substring(0, 150)

                        return (

                            <li className="flex w-96 lg:128 flex-col justify-center bg-black text-white mt-5 mb-5 md:mr-3 md:ml-3 rounded-3xl" key={response.id}>
